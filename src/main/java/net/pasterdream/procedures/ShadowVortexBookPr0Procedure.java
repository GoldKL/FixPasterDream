		...
		if (entity instanceof Player) {
			if (entity instanceof LivingEntity lv ? CuriosApi.getCuriosHelper().findEquippedCurio(PasterdreamModItems.QYM_HEAD.get(), lv).isPresent() : false == true) {
				...
				if (entity instanceof ServerPlayer _plr4 && _plr4.level() instanceof ServerLevel
					...
					((LivingEntity) entity).getAttribute(PasterdreamModAttributes.SAN.get()).setBaseValue((((LivingEntity) entity).getAttribute(PasterdreamModAttributes.SAN.get()).getValue() - 0.05));
					{
