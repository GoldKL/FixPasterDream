...
public class BaconeEggItem extends Item {
	public BaconeEggItem() {
		super(new Item.Properties().stacksTo(64).rarity(Rarity.COMMON).food((new FoodProperties.Builder()).nutrition(10).saturationMod(1.2f).build()));
	}
