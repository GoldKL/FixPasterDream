...
import net.pasterdream.procedures.Buncake1Pr0Procedure;
...
public class Buncake1Item extends Item {
	public Buncake1Item() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.literal("\u00A77\u25AA \u00A79\u901F\u5EA6I (1:00)"));
	...
	public ItemStack finishUsingItem(ItemStack itemstack, Level world, LivingEntity entity) {
		...
		Buncake1Pr0Procedure.execute(world, x, y, z, entity, itemstack);
		return retval;
	}
}
