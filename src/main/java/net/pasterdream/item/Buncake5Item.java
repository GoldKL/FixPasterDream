...
import net.pasterdream.procedures.Buncake5Pr0Procedure;
...
public class Buncake5Item extends Item {
	public Buncake5Item() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.literal("\u00A77\u25AA \u00A79\u591C\u89C6I (1:00)"));
	...
	public ItemStack finishUsingItem(ItemStack itemstack, Level world, LivingEntity entity) {
		...
		Buncake5Pr0Procedure.execute(world, x, y, z, entity, itemstack);
		return retval;
	}
}
