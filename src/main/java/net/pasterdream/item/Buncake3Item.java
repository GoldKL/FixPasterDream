...
import net.pasterdream.procedures.Buncake3Pr0Procedure;
...
public class Buncake3Item extends Item {
	public Buncake3Item() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.literal("\u00A77\u25AA \u00A79\u751F\u547D\u6062\u590DI (0:20)"));
	...
	public ItemStack finishUsingItem(ItemStack itemstack, Level world, LivingEntity entity) {
		...
		Buncake3Pr0Procedure.execute(world, x, y, z, entity, itemstack);
		return retval;
	}
}
