...
import net.pasterdream.procedures.Buncake2Pr0Procedure;
...
public class Buncake2Item extends Item {
	public Buncake2Item() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.literal("\u00A77\u25AA \u00A79\u6025\u8FEBI (1:00)"));
	...
	public ItemStack finishUsingItem(ItemStack itemstack, Level world, LivingEntity entity) {
		...
		Buncake2Pr0Procedure.execute(world, x, y, z, entity, itemstack);
		return retval;
	}
}
