...
public class PineappleLoveSeaItem extends Item {
	public PineappleLoveSeaItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.literal("\u00A77\u25AA \u00A79\u5373\u65F6\u6062\u590Dsan+20"));
		list.add(Component.literal("\u00A77\u25AA \u00A79\u6599\u7406I (5:00)"));
		list.add(Component.literal("\u00A77\u00A7o--\u4EC5\u9700\u4E00\u53E3 \u5C31\u80FD\u8BA9\u72FC\u72FC\u8FF7\u9189"));
	}
