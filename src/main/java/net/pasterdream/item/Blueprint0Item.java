...
import net.pasterdream.procedures.Blueprint0Pr0Procedure;
import net.pasterdream.item.inventory.Blueprint0InventoryCapability;
...
public class Blueprint0Item extends Item {
	public Blueprint0Item() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.literal("\u00A7b\u6697\u5F71\u9AD8\u7089"));
		...
		if (entity instanceof ServerPlayer serverPlayer) {
			NetworkHooks.openScreen(serverPlayer, new MenuProvider() {
				...
				public Component getDisplayName() {
					return Component.literal("Blueprint 0");
				}
	...
	public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
		...
		if (selected)
			Blueprint0Pr0Procedure.execute(entity);
	}

	@Override
	public ICapabilityProvider initCapabilities(ItemStack stack, @Nullable CompoundTag compound) {
		return new Blueprint0InventoryCapability();
	}
