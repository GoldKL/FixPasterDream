...
import net.pasterdream.procedures.Buncake4Pr0Procedure;
...
public class Buncake4Item extends Item {
	public Buncake4Item() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.literal("\u00A77\u25AA \u00A79\u8DF3\u8DC3\u63D0\u5347I (1:00)"));
	...
	public ItemStack finishUsingItem(ItemStack itemstack, Level world, LivingEntity entity) {
		...
		Buncake4Pr0Procedure.execute(world, x, y, z, entity, itemstack);
		return retval;
	}
}
